...
#### load gff file ####
#cat("Skip : Loading gff file: ",gffFile,"\n")
...
cat("Skip:Checking for mismatch between GFF and protein fasta:\n")
...
write.fasta(sequences = AAseqs,
            names = names(AAseqs), # use geneID as identifier!
...
write.fasta(sequences = CDSseqs,
            names =  names(CDSseqs), # use geneID as identifier!
