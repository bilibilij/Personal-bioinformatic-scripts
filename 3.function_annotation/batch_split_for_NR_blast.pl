...
for (1..$mark) { 
	print COMMAND "/export/databases/NR/nr_blast/split_NR/diamond blastx --db /export/databases/NR/nr_blast/split_NR/Viridiplantae.nr2019.dmnd --query ../$out_name.tmp/$out_name.$_.fasta  --out ../$out_name.tmp/$out_name.$_.nrBlast.tab -p $cpu --outfmt 5 --sensitive  --evalue 1e-5 --id 20 --index-chunks 1 --tmpdir  ../$out_name.tmp\n";
}
